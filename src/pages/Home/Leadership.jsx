          ...
          <div className="lg:col-span-7">
            ...
            <div className="space-y-8 max-w-2xl">
              <p className="font-body text-xl md:text-2xl text-on-surface-variant italic leading-relaxed">
                "Our goal at Suave Innovations isn't just to install systems,
                but to build the invisible infrastructure that makes modern life
                effortless. With Dékódèrè, we ensure that technical excellence
                is always wrapped in exceptional design."
              </p>

              <div className="pt-8 border-t border-outline-variant/20">
                <h4 className="font-headline text-2xl font-bold text-on-surface tracking-tight">
                  Kehinde Dada —{" "}
                  <span className="text-secondary/60 font-light">Founder</span>
                </h4>
